...
import {createComment, checkFormErrors, editPost} from '../actions';
...
class NewComment extends Component {
  ...
  handleSubmit(e){
    ...
    .then(()=>this.props.updateList({...this.props.post, commentCount: this.props.post.commentCount + 1})) // update in the list
